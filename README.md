...
[![Release](https://img.shields.io/badge/release-v0.2.1-cb3837?logo=github&logoColor=white)](https://github.com/VidGuiCode/az-where/releases)
...
```bash
npm install -g https://github.com/VidGuiCode/az-where/releases/download/v0.2.1/az-where-0.2.1.tgz
```
